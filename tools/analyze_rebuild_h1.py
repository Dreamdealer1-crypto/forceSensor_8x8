#!/usr/bin/env python3
"""Analyze ORDER-REBUILD-H1 transfer captures."""
...
NON_OPEN_PRIMARY = ["1M", "680k", "470k", "220k", "100k", "68k", "47k", "22k", "10k"]
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze ORDER-REBUILD-H1 transfer dataset.")
